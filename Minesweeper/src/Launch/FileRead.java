...
public class FileRead {
    ...
    public ArrayList<String> list(int difficult){
        ...
        File file = new File("E:\\Hicheel\\Buteelt\\Minesweeper\\src\\LeaderBoard\\LeaderBoard.txt");
    ...
    public Boolean addName(int difficult, String name, int score) {
        ...
        String fileName = "E:\\Hicheel\\Buteelt\\Minesweeper\\src\\LeaderBoard\\LeaderBoard.txt";
